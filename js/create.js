...
async function connectMetamask() {
    if (typeof window.ethereum !== 'undefined') {
        ...
        document.getElementById("connectedImg").style.display = "inline";
...
async function makeMyNFT() {
    ...
    let receiverAddress = await document.getElementById("recpWallet").value;
    let filelink = await document.getElementById("filelink").value;
    ...
    try {
        ...
        document.getElementById("TrxResult").className = "res-inputs";
        document.getElementById("trxidtxtbox").value = txHash;
...
function copyTrx() {
    ...
    navigator.clipboard.writeText(document.getElementById("trxidtxtbox").value);
    document.getElementById("cpimg").src = "./images/copied.png";
